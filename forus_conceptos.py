...
NORMALIZACION = [
    ...
    (r"DESCUENTO.*(?:PROMOCION|PUBLICIDAD)", "DESCUENTO FONDO DE PROMOCION"),
    ...
    # --- promocion ---
    (r"(?:FONDO|GASTO|APORTE).*PROMOCION", "FONDO DE PROMOCION"),
    (r"PROMOCION", "FONDO DE PROMOCION"),
    (r"\bPUBLICIDAD\b|\bMARKETING\b", "FONDO DE PROMOCION"),
    ...
    (r"\bENERGIA\b|\bELECTRICIDAD\b|\bLUZ\b", "ENERGIA ELECTRICA"),
